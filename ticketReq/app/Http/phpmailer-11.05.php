...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'ecompstix@nymets.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Ecomps';
   ...
   * @var string
   */
  public $Sender            = 'ecompstix@nymets.com';
   ...
   * @var string
   */
  public $Hostname          = 'mets2k8mail02.ny-mets.com';
   ...
   * @var string
   */
  public $Host        = 'mets2k8mail02.ny-mets.com';
   ...
   * @var string
   */
  public $Helo        = 'mets2k8mail02.ny-mets.com';
   ...
   * @var string
   */
  public $Username     = 'ny-mets\jburk';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password     = '$mtptest';
  ...
  */
  ...
  public function MsgTEXT($message,$basedir='') {
    preg_match_all("/(src|background)=\"(.*)\"/Ui", $message, $images);
    if(isset($images[2])) {
      foreach($images[2] as $i => $url) {
        // do not change urls for absolute images (thanks to corvuscorax)
