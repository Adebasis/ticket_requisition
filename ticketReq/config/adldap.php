            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'account_suffix' => env('ADLDAP_ACCOUNT_SUFFIX', '@ny-mets.com'),
                ...
                */
				...
				'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'mets2k12pdc01.ny-mets.com')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'dc=ny-mets,dc=com,cn=Users'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'mwashington'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'reboot2016'),
