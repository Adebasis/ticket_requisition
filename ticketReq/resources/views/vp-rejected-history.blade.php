                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped table-hover b-t b-light" align="center" border="1" id="example" bordercolor="#ccc" style="border-collapse:collapse; color:#000; font-size:13px;">
							...
							$str = "select * from request where ".$cond." And user_cancel=1 order by CreateDate desc";
                            ...
                            @foreach ($data as $index=>$tmpdata)
                              ...
                              <tr style="cursor:pointer;">
                                ...
                                <?php }else if($tmpdata->vc_status == "1" || $tmpdata->approve_by_admin == "1" || ($tmpdata->first_approver_status == "1" && $tmpdata->second_approver_status == "1")){?>
                                ...
                                <?php }else{?>
                                    <div style="width:50%; text-align:center; float:left;">
										...
										if($tmpdata->first_approver > 0){
											$res_ap = DB::table('useraccount')->select('FirstName', 'LastName')->where('id', $tmpdata->first_approver)->get();
											$by = $res_ap[0]->FirstName.' '.$res_ap[0]->LastName;
										}else if($tmpdata->approve_by_admin == "1"){
											$by = "Administrator";
										}else{
											$by = "Me";
										}*/
										?>
                                        <div class="text-<?php if($tmpdata->first_approver_status=="1" || $tmpdata->approve_by_admin == "1"){?>success<?php }else if($tmpdata->first_approver_status=="2" || $tmpdata->is_cancel == "1"){?>danger<?php }?>"<?php /*?> data-toggle="popover" data-html="true" data-placement="bottom" data-content="&lt;div class='scrollable' style='height:40px'&gt;Approved By : <?php echo $by;?>.&lt;/div&gt;" title="" data-original-title="&lt;button type=&quot;button&quot; class=&quot;close pull-right&quot; data-dismiss=&quot;popover&quot;&gt;×&lt;/button&gt;Approver"<?php */?>>
                                    ...
                                    <div style="width:50%; text-align:center; float:left;">
                                        <?php
										/*$by = "";
										if($tmpdata->second_approver > 0){
											$res_ap = DB::table('useraccount')->select('FirstName', 'LastName')->where('id', $tmpdata->second_approver)->get();
											$by = $res_ap[0]->FirstName.' '.$res_ap[0]->LastName;
										}else if($tmpdata->approve_by_admin == "1"){
											$by = "Administrator";
										}else{
										...
										?>
                                        <div class="text-<?php if($tmpdata->second_approver_status=="1" || $tmpdata->approve_by_admin == "1"){?>success<?php }else if($tmpdata->second_approver_status=="2"){?>danger<?php }?>" <?php /*?>data-toggle="popover" data-html="true" data-placement="bottom" data-content="&lt;div class='scrollable' style='height:40px'&gt;Approved By : <?php echo $by;?>.&lt;/div&gt;" title="" data-original-title="&lt;button type=&quot;button&quot; class=&quot;close pull-right&quot; data-dismiss=&quot;popover&quot;&gt;×&lt;/button&gt;Approver"<?php */?>>
                                            <i class="fa fa-circle"></i>
                                        </div>
                                    </div>
                                <?php }?>
