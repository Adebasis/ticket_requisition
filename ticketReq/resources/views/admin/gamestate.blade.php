        ...
        <section class="hbox stretch">
            ...
            <section class="panel">
                ...
                <div class="row wrapper">
                    ...
                    {!! Form::open(['method'=>'GET','url'=>'adminpanel/gamestate','class'=>'','role'=>'search'])  !!}
                    ...
                    <div class="col-sm-1">
                        <div class="input-group">
                            <span class="input-group-btn">
                            <a href="{{ url('/adminpanel/gamestate/entry') }}"><button class="btn btn-sm btn-default" type="button">ADD NEW</button></a>
                            </span>
                        </div>
                    </div>
                </div>
                  ...
                  <table class="table table-striped table-hover b-t b-light" border="1" bordercolor="#ccc" style="border-collapse:collapse; color:#000;">
                    <thead>
                      <tr>
                        ...
                        <th class="th-sortable bgtable" data-toggle="class">Game State</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="{{url('adminpanel/gamestate')}}/{{$tmpdata->id}}/edit"><button type="button" class="btn btn-default btn-xs">&nbsp;&nbsp;Edit&nbsp;&nbsp;</button></a>&nbsp;<a href="{{url('adminpanel/gamestate')}}/{{$tmpdata->id}}/delete" onclick="return confirm('Are you sure you want to delete this record ?');"><button type="button" class="btn btn-default btn-xs">Delete</button></a>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
