    ...
    <section>
        <section class="hbox stretch">
            ...
            <section class="panel">
                ...
                <div class="wrapper">
                    <div class="col-sm-4">
                    <span style="font-size:14px; font-weight:bold;"><i class="fa fa-envelope icon-muted"></i>&nbsp;Requested Tickets By Teams</span>
                    </div>
                    <?php
                    ...
                    {!! Form::open(['method'=>'GET','url'=>'adminpanel/reports/requested/teams','class'=>'','role'=>'search'])  !!}
                    
                    <div class="col-sm-3">
                    <select name="game" class="form-control">
                        <option value="">SELECT TEAM</option>
                        <?php foreach($games as $t){ ?>
                        <option value="<?php echo $t->id;?>" <?php if($t->id == $game){?> selected="selected" <?php }?>><?php echo $t->Name;?></option>
                        <?php }?>
                    </select>
                    </div>
                    ...
                    {!!Form::open(array('action'=>'AdminController@admin_post_reports_requested_teams_download','method'=>'post','onsubmit'=>'return Validation();'))!!}
