                        ...
                        <section class="vbox">
                            ...
                            <div class="panel-body" style="padding:0;">
								...
								function send(){
									...
									$.ajax({
										type: "POST",
										url: url + "/adminPost_RequestPageMessageBoard",
										data: {"message":message ,"_token":csrf,"request_id":request_id},
										success: function (data) {
											window.location = url +'/adminpanel/requests/'+ request_id +'/message/board';
										}
									});
								}
								</script>
                                <div class="col-sm-6">
                                	...
                                	<div class="col-sm-12 row text-right">
                                      <textarea class="form-control" style="height:60px;" onkeyup="countChar(this, 'msg_char');" id="message"></textarea>
                                      <br />
                                    	<input type="button" class="btn btn-default btn-sm text-left" style="margin-top:-30px;" value="SEND" onclick="send();" /><a href="{{ url('/') }}/adminpanel/requests"><input type="button" class="btn btn-default btn-sm text-left" style="margin-top:-30px;" value="BACK"  /></a>
                                  	</div>
                                </div>
                                <div class="col-sm-3">&nbsp;</div>
                            </div>
