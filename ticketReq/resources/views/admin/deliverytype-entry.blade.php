                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <section class="panel panel-default">
                                            ...
                                            <header class="panel-heading font-bold">Delivery Type [Entry]</header>
                                            <div class="panel-body">
                                            
                                                {!!Form::open(array('action'=>'AdminController@admindeliverytypeentry','method'=>'post','onsubmit'=>'return Validation()'))!!}
