                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <section class="panel panel-default">
                                            ...
                                            <header class="panel-heading font-bold">500 Customize Error </header>
                                            <div class="panel-body">
                                            
                                                {!!Form::open(array('action'=>'AdminController@edit_customize_error','method'=>'post','onsubmit'=>'return Validation()'))!!}
