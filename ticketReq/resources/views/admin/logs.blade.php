										...
										<section class="vbox">
                                            <section class="scrollable wrapper">
                                              <div class="timeline" id="timeline">
                                                    ...
                                                    <div class="timeline-caption">
                                                      <div class="panel bg-primary lt no-borders">
                                                        <div class="panel-body text-center">
                                                          <span class="timeline-icon"><i class="fa fa-th-large time-icon bg-primary"></i></span>
                                                          <span class="h4 m-r-sm" id="topfocus">Event Logs</span>
                                                        </div>
                                                      </div>
                                                    </div>
                                                </article>
                                                ...
                                                <?php
												$i = 0;
												$all = DB::table('logs')->orderBy('created_date', 'desc')->take(1)->get();
												...
												function loadmore(){
													...
													$.ajax({
														type: "POST",
														url: url + "/admin_post_logs_load_more_page",
														data: {"_token":csrf,"last_id":last_id},
														success: function (data) {
															if(data != ""){
																...
																//alert(last_id)
																$('html, body').animate({
																	scrollTop: $("#focus"+last_id).offset().top
																}, 1500);
															}
														}
													});
