    ...
    <section>
        <section class="hbox stretch">
            ...
            <section class="panel">
                ...
                <div class="wrapper">
                    <div class="col-sm-4">
                    <span style="font-size:14px; font-weight:bold;"><i class="fa fa-envelope icon-muted"></i>&nbsp;Fulfulled Tickets By Games</span>
                    </div>
                    <?php
                    ...
                    {!! Form::open(['method'=>'GET','url'=>'adminpanel/reports/fulfilled/games','class'=>'','role'=>'search'])  !!}
                    ...
                    {!!Form::open(array('action'=>'AdminController@admin_post_reports_fulfilled_games_download','method'=>'post','onsubmit'=>'return Validation();'))!!}
