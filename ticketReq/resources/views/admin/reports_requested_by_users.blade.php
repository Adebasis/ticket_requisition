    ...
    <section>
        <section class="hbox stretch">
            ...
            <section class="panel">
                ...
                <div class="wrapper">
                    <div class="col-sm-4">
                    <span style="font-size:14px; font-weight:bold;"><i class="fa fa-envelope icon-muted"></i>&nbsp;Requested Tickets By Users</span>
                    </div>
                    <?php
                    ...
                    {!! Form::open(['method'=>'GET','url'=>'adminpanel/reports/requested/users','class'=>'','role'=>'search'])  !!}
                    ...
                    {!!Form::open(array('action'=>'AdminController@admin_post_reports_requested_users_download','method'=>'post','onsubmit'=>'return Validation();'))!!}

                    <div class="col-sm-2">
                        <div class="input-group">
                            <span class="input-group-btn">
                            <input type="hidden" name="tmp_requestor" value="<?php echo $requestor;?>" />
