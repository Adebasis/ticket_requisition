            ...
            <section class="hbox stretch">
                ...
                <section class="vbox">
                    <section class="scrollable padder">              
                        ...
                        <div class="row"><?php //echo gethostbyname($_SERVER['SERVER_NAME']);?>
                            ...
                            <div class="col-sm-6">
                                <section class="panel panel-default">
                                	...
                                	<header class="panel-heading font-bold">SMTP Settings</header>
                                    <div class="panel-body" title="">
                                        
                                        <?php
										/*\DB::transaction(function () {
											\DB::table('smtp1')->where('id','=',4)->update(array('host'=>'ki'));
											\DB::table('smtp1')->where('id', '=', 5)->delete();
										});
										*/
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                {!!Form::text('server_ip', $smtp[0]->server_ip, array('class'=>'form-control','id'=>'host','maxlength'=>50, 'required'))!!}
                                            </div>
                            ...
                            <div class="col-sm-6">
                                <section class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            	{{ Form::label('server_ip1', 'Server IP') }}
                                                {!!Form::text('server_ip1', $smtp[0]->server_ip, array('class'=>'form-control','id'=>'host','maxlength'=>50, 'required'))!!}
                                            </div>
                                            <div class="col-sm-12">&nbsp;</div>
                                            <div class="col-sm-6">
