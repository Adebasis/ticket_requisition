...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">    
    <div class="container aside-xl">
        ...
        <section class="m-b-lg">
            ...
            {!! Form::open(array('action' => 'AdminController@postResetPassword', 'id'=>'form1','autocomplete'=>'on')) !!}
                ...
                <p><h6 style="color:#F00;">{!! Session::get('error') !!}</h6></p>
                @endif
                @if(Session::has('msg'))
                <p><h6 style="color:#090;">{!! Session::get('msg') !!}</h6></p>
                @endif
