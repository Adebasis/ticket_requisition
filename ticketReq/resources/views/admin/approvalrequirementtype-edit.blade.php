                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <section class="panel panel-default">
                                            ...
                                            <header class="panel-heading font-bold">Approval Requirement Type [Edit]</header>
                                            <div class="panel-body">
                                            
                                                {!!Form::open(array('action'=>'TeamController@admin_post_approvalrequirementtype_edit','method'=>'post','onsubmit'=>'return Validation()'))!!}
                                                ...
                                                <script>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        {!!Form::textarea('Description',$data[0]->Description,array('class'=>'form-control','id'=>'Description', 'autofocus','rows'=>'5','onkeyup'=>'countChar(this, "Instructions_char");'))!!}
                                                    </div>
