                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <section class="panel panel-default">
                                            ...
                                            <header class="panel-heading font-bold">Pricing Type [Entry]</header>
                                            <div class="panel-body">
                                            
                                                {!!Form::open(array('action'=>'TeamController@admin_post_pricingtype_entry','method'=>'post','onsubmit'=>'return Validation()'))!!}
                                                    ...
                                                    {!!Form::textarea('Description',null,array('class'=>'form-control','id'=>'Description', 'rows'=>'5','onkeyup'=>'countChar(this, "Instructions_char");'))!!}
                                                    </div>
                                                    <div class="row">
                                                    <div class="form-group">
                                                    <div class="col-sm-6">
                                                    ...
                                                    {{Form::select('IsEnabled',['1'=>'Yes','0'=>'NO'],'null',['class'=>'form-control','id'=>'IsEnabled'])}}
                                                    </div>
                                                    </div>
                                                    </div>
                                                    <div class="row">
