                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <section class="panel panel-default">
                                            ...
                                            <header class="panel-heading font-bold">Employee Type [Edit]</header>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <div class="col-sm-6">
                                                                ...
                                                                {!!Form::number('FulfillmentOrder', $data[0]->FulfillmentOrder, array('class'=>'form-control','id'=>'FulfillmentOrder'))!!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
