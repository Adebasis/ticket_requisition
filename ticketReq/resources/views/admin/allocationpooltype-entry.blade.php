                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <section class="panel panel-default">
                                            ...
                                            <header class="panel-heading font-bold">Allocation Pool Type [Entry]</header>
                                            <div class="panel-body">
                                            
                                                {!!Form::open(array('action'=>'TeamController@admin_post_allocationpooltype_entry','method'=>'post','onsubmit'=>'return Validation()'))!!}
                                                    
                                                    <div class="form-group">
                                                    {{ Form::label('Name', 'Pool Type Name') }}
                                                    ...
                                                    {!!Form::number('UiSort', 0, array('class'=>'form-control','id'=>'UiSort'))!!}
                                                    </div>
                                                    </div>
                                                    </div>
                                                    <div class="row">
