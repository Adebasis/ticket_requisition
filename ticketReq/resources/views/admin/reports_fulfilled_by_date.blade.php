    ...
    <section>
        <section class="hbox stretch">
            ...
            <section class="panel">
                ...
                <div class="wrapper">
                    <div class="col-sm-4">
                    <span style="font-size:14px; font-weight:bold;"><i class="fa fa-envelope icon-muted"></i>&nbsp;Fulfilled Tickets By Date</span>
                    </div>
                    
                    {!! Form::open(['method'=>'GET','url'=>'adminpanel/reports/fulfilled/date','class'=>'','role'=>'search'])  !!}
                    ...
                    {!!Form::open(array('action'=>'AdminController@admin_post_reports_fulfilled_date_download','method'=>'post','onsubmit'=>'return Validation();'))!!}
