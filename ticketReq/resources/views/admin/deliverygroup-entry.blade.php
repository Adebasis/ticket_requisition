                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <section class="panel panel-default">
                                            ...
                                            <header class="panel-heading font-bold">Delivery Group [Entry]</header>
                                            <div class="panel-body">
                                            
                                                {!!Form::open(array('action'=>'TeamController@admin_post_deliverygroup_entry','method'=>'post','onsubmit'=>'return Validation()'))!!}
                                                     ...
                                                     <div class="form-group">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="checkbox i-checks">
                                                              <label>
                                                                {{ Form::checkbox('task_id[]', $tmptask->id, '', ['class' => 'field']) }}
                                                                <i></i>{{ $tmptask->Name }}
                                                              </label>
                                                            </div>
                                                            @endforeach
