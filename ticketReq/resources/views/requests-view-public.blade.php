                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <?php
																		$dept = getDataFromTable("department","Name","id", $data[0]->dept_id);
																		?>
                                                                        <input type="text" class="form-control" disabled="disabled" value="<?php echo $dept;?>" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <?php
																			$locationtype = getDataFromTable("locationtype","Name","id", $data[0]->locationtype_id);
																			?>
                                                                            <input type="text" class="form-control" disabled="disabled" value="<?php echo $locationtype;?>" />
                                                                            
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            {{ Form::label('deliverytype_id', 'DELIVERY') }}
                                                                            <?php
																			$deliverytype = getDataFromTable("deliverytype","Name","id", $data[0]->deliverytype_id);
																			?>
                                                                            <input type="text" class="form-control" disabled="disabled" value="<?php echo $deliverytype;?>" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group text-center" style="border-top:dotted 2px #fff; color:#F00; padding-left:20px;">
                                                            <h2>Please login to Approve OR Reject for this request !!!</h2>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
