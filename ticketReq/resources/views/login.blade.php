...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">    
    <div class="container aside-xl">
        ...
        <section class="m-b-lg">
            ...
            {!! Form::open(array('action' => 'HomeController@postLogin', 'id'=>'form1','autocomplete'=>'on')) !!}
                ...
                <div class="text-center m-t m-b"><a href="{{ url('reset/password') }}"><small>Reset password?</small></a></div>
