    ...
    <div class="container aside-xl">
        ...
        <section class="m-b-lg">
            <header class="wrapper text-center">
                <strong>Sign in Here<?php //echo $_SERVER['REMOTE_ADDR'];?></strong>
            </header>
        	        
            <?php echo Form::open(array('action' => 'HomeController@postLogin', 'id'=>'form1','autocomplete'=>'on')); ?>
                ...
                <div class="text-center m-t m-b"><a href="<?php echo e(url('reset/password')); ?>"><small>Reset password?</small></a></div>
