                                                            ...
                                                            <div class="">
                                                                <div class="easypiechar1t easyPieChart1" data-percent="75" data-line-width="6" data-bar-color="#fff" data-track-color="#2796de" data-scale-color="false" data-size="140" data-line-cap="butt" data-animate="1000" style="height: 140px; line-height: 140px;">
                                                                    <div class="thumb-lg avatar">
                                                                        <img src="<?php echo e(url('/')); ?>/public/admin_assets/images/a0.png" class="dker">
                                                                    </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($reqs as $index => $tmpreqs) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"><a href="<?php echo e(url('history/request/')); ?>/<?php echo e($tmpreqs->id); ?>/message/board"><button type="button" class="btn btn-default btn-xs">Message</button><?php if ($is_unread_message > 0) { ?>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($data as $index => $tmpdata) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo e($tmpdata->RecipientFirstName); ?> <?php echo e($tmpdata->RecipientLastName); ?></td>
                                                                    <td class="text-center"><?php echo e($tmpdata->CompanyName); ?></td>
                                                                    <td class="text-center"><?php echo e(date('m/d/Y', strtotime(getDataFromTable("game","OriginalGameDate","id", $tmpdata->game_id )))); ?></td>
                                                                    <td class="text-center"><?php echo e(date('m/d/Y', strtotime($tmpdata->CreateDate))); ?></td>
                                                                    <td class="text-center"><?php echo e(getDataFromTable("locationtype","Name","id", $tmpdata->locationtype_id )); ?></td>
                                                                    <td class="text-center"><?php echo e(getDataFromTable("deliverytype","Name","id", $tmpdata->deliverytype_id )); ?></td>
                                                                    <td class="text-center"><?php echo e($tmpdata->Comp); ?>/<?php echo e($tmpdata->Purchased); ?></td>
